...
extern int count_open;
extern uint8 ok_flag;
extern volatile long int Feedback_Speed_tmpL;
extern volatile long int Feedback_Speed_tmpR;
extern volatile short int speedR;
extern volatile short int speedL;
extern volatile int Feedback_SpeedL;
extern volatile int Feedback_SpeedR;
extern volatile int speedR1;
extern volatile int speedL1;
